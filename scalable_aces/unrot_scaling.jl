...
dep_worst_idx = 3
repetitions = 400
d_gls = load_design(unrotated_param, dep_param, gls_tuple_number, gls_repeat_numbers, true)
d_wls = load_design(
    unrotated_param,
...
jldsave(
    pwd() *
    "/data/design_merit_data_$(code_filename(unrotated_param))_$(noise_filename(log_param)).jld2";
    expectation_array,
    variance_array,
    gls_expectation_set,
    gls_variance_set,
